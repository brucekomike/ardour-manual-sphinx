...
computer---in this example, the cable connecting between the mixer and
the computer.
...
For some cases, Ardour eliminates possible I/O issues. One such case is
automatically saving I/O per device to sessions and restoring
connections when switching the backend, e.g. from ALSA to PulseAudio and
vice versa.
