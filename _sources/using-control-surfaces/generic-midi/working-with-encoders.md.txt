...
-   enc-r: Relative Signed Bit. If the most sign bit is set, Then the
    ...
    `0svvvvvv`. Where s is the sign or direction and vvvvvv is the
    number of ticks turned.
...
-   enc-b: Relative Binary Offset. Positive offsets are sent as offset
    plus 64 and negative offsets are sent as 64 minus offset. 64 is
    zero, 65 is +1, 63 is -1. `<Binding channel="1" enc-b="13" …`
