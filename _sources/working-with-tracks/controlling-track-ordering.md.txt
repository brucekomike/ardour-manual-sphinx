...
-   In the [Editor]{.dfn} window, the Master bus will always be on top
    ...
    from top to bottom. The monitor section (if used) is never visible
...
-   Selecting the tracks to be moved in the [[Tracks & Busses]{.kbd
    .menu} panel of the Editor Lists](@@the-tracks-and-busses-list)
    dock, then dragging them up or down.
