...
-   the audio or MIDI [source file(s)]{.dfn} they represent,
-   an [offset]{.dfn} (the \"start point\") in the audio or MIDI
    file(s), and
-   a [length]{.dfn}.
...
-   [Ctrl]{.kbd}-[left]{.kbd .mouse}-click adds individual regions to
    the selection.
...
-   Use [Region \> Ungroup Selected Regions]{.kbd .menu} in the main
    menu
-   Use [Selected Regions \> Ungroup Selected Regions]{.kbd .menu} in
